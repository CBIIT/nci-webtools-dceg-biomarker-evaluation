...
drawGraph <-function(independent, fixed, contour, firstinputVector, secondinputVector, tableName, tabvalue, uniqueId, fixedVal)
{
    ...
    if (exists(as.character(substitute(drawfunctionname))))
    {
        ...
        returnvalue<- drawfunction(firstinputVector,secondinputVector,as.numeric(fixedVal));
